...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg "545464"
  put_template_custom Ph "f2ecbc"
  put_template_custom Pi "545464"
  put_template_custom Pj "545464"
  put_template_custom Pk "f2ecbc"
  put_template_custom Pl "43436c"
  put_template_custom Pm "f2ecbc"
else
