...
put_template 7  "ba/c2/de"
put_template 8  "58/5b/70"
put_template 9  "f7/ae/c2"
put_template 10 "c2/ec/bf"
put_template 11 "fc/d6/82"
put_template 12 "ae/cc/fc"
put_template 13 "f3/98/da"
put_template 14 "b1/ea/e1"
put_template 15 "a6/ad/c8"
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pj "f5e0dc"
  put_template_custom Pk "1e1e2e"
