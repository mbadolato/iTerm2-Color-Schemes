...
put_template 7  "c8/c8/c8"
put_template 8  "6c/6c/6c"
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pi "e1e1e1"
  put_template_custom Pj "242424"
  put_template_custom Pk "e1e1e1"
  put_template_custom Pl "e0af68"
